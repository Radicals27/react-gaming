...
export default function SearchDropdown({ result }) {
  return (
    <Fragment>
      <a key={result.id + 'a'} href={`https://react-gaming.herokuapp.com/games/${result.id}-${result.slug}`} className='text-decoration-none'>
...
export function SearchDropdownNoResult() {
  return (
